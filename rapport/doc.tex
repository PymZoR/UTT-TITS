...
\begin{document}
    ...
    \include{parts/01-structure/01-general}
    \include{parts/01-structure/02-coeur}
    \include{parts/01-structure/03-esclaves}
    \include{parts/02-algorithme/01-odometrie}
    \include{parts/02-algorithme/02-asservissement}
    \include{parts/03-conclusion}

    \appendix
    \include{parts/04-Annexes}
